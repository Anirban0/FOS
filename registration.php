...
if (isset($_POST['submit'])) {
  ...
  $qry = "INSERT INTO `customer` (`cust_fname`, `cust_lname`, `email`, `cust_password`) VALUES ('$cust_fname','$cust_lname','$email','$cust_password')";
  $run = mysqli_query($con, $qry);
  if ($run == TRUE) {
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>HOLY MOLY!</strong> Use has been succesfully registrered.
